...
<section class="page__main page__main--popular">
    ...
    <div class="popular container">
        ...
        <div class="popular__posts">
            ...
            <article class="popular__post post <?= $post_card['type']; ?>">
                <header class="post__header">
                    <h2><?= $post_card['title']; ?></h2>
                </header>
                <div class="post__main">
                    ...
                    <div class="post-link__wrapper">
                        <a class="post-link__external" href="http://<?= $post_card['content']; ?>" title="Перейти по ссылке">
                            <div class="post-link__info-wrapper">
                                <div class="post-link__icon-wrapper">
                                    <img src="https://www.google.com/s2/favicons?domain=vitadental.ru" alt="Иконка">
                                </div>
                                <div class="post-link__info">
                                    <h3><?= $post_card['title']; ?></h3>
                                </div>
                            </div>
                            <span><?= $post_card['content']; ?></span>
                        </a>
                    </div>
                    <?php else: ?>
                    <div class="post-video__block">
                        <div class="post-video__preview">
                            <?=embed_youtube_cover($post_card['content']); ?>
                    ...
                    <div class="post__author">
                        <a class="post__author-link" href="#" title="Автор">
                            <div class="post__avatar-wrapper">
                                ...
                                <img class="post__author-avatar" src="img/<?= $post_card['img']; ?>" alt="Аватар пользователя">
                            </div>
                            <div class="post__info">
                                <b class="post__author-name"><?= $post_card['author']; ?></b>
